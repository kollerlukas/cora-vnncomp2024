...
nnCora = neuralNetwork.convertDLToolboxNetwork(nnDltInit.Layers,false);
...
res1 = all(abs(weightsDiff) <= 1e-6); % Deep-Learning Toolbox uses single
...
res2 = length(loss.center) == numIterations;
